...
type Kind = 'legal' | 'illegal' | 'planning';
...
export function TripStatusBar({ kind, plan, reason }: TripStatusBarProps) {
  ...
  const arrival =
    plan && plan.timeline.length > 0 ? plan.timeline[plan.timeline.length - 1].end_time : null;
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-sm text-slate-600">
              {kind === 'legal' && 'The schedule below meets the federal hours-of-service limits.'}
